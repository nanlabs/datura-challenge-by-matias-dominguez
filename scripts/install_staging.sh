...
setup_environment() {
    ...
    cd ../datura-challenge-by-matias-dominguez

    # Install the datura-challenge-by-matias-dominguez python package
...
## Setup localnet
# assumes we are in the datura-challenge-by-matias-dominguez/ directory
